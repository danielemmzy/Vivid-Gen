...
@app.cls(
    image=image,
    volumes={
        "/s3-mount": modal.CloudBucketMount("hey-gen-buckets-dan", secret=s3_secret)
    },
    timeout=600,
    secrets=[s3_secret]
)
...
def main():
    ...
    test_url = "https://public-hey-gen-dan.s3.eu-central-1.amazonaws.com/samples/voices/vits.mp3"

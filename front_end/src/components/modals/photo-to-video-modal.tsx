...
const samplePhotos = [
  {
    ...
    url: "https://public-hey-gen-dan.s3.eu-central-1.amazonaws.com/samples/photos/0008.jpg",
  },
  {
    s3Key: "samples/photos/0009.jpg",
    url: "https://public-hey-gen-dan.s3.eu-central-1.amazonaws.com/samples/photos/0009.jpg",
  },
  {
    s3Key: "samples/photos/0003.jpg",
    url: "https://public-hey-gen-dan.s3.eu-central-1.amazonaws.com/samples/photos/0003.jpg",
  },
];
...
export function PhotoToVideoModal({
  ...
  const handleGenerateVideo = async () => {
    ...
    toast.success("photo to video job queued! You will be able to see the status on the dashboard.")
          ...
          <div className="flex flex-col gap-8 p-8 lg:flex-row">
            ...
            <div className="flex flex-1 flex-col gap-4">
              <div className="relative">
                {selectedAudioUrl ? (
                  <div className="flex items-center gap-3 rounded border bg-gray-50 p-3">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setSelectedAudioName("new_recording.wav");
                      }}
                    >
                      <Trash2 className="h-5 w-5 text-gray-600" />
                    </button>
                  ...
                  <>
                    ...
                    <Button
                      ...
                      className={`${script ? "hidden" : ""} absolute top-7 left-0.5 cursor-pointer text-base underline md:text-sm lg:top-[3px] lg:left-[165px]`}
                    >
                ...
                {/* Container at the bottom of the text area */}
                  ...
                  <div className="item-center mt-2 flex gap-2">
                    {!selectedAudioUrl &&
                      (customVoiceFile ? (
                        <div className="item-center flex gap-2">
                          <button
                            className="flex cursor-pointer items-center gap-1 text-sm font-medium text-gray-600 hover:text-purple-600"
                    ...
                    {!selectedAudioUrl && (
                      <span className="ml-auto text-xs text-gray-400">
                        {script.length} / 420 (30 seconds max)
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="flex gap-6">
                ...
                {experimentalModel && (
                  <div className="bottom-5 flex items-center gap-2">
                    <Switch
                      checked={enhancement}
              ...
              <div className="mt-2 flex flex-wrap gap-6">
                ...
                <div className="flex w-full items-center justify-end">
                  ...
                  >
                    {loading ? <Loader2 className="mr-2 h-4 w-4" /> : null}
                    Generate Video
                  </Button>
                </div>
              </div>

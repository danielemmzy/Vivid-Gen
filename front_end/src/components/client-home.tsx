...
const features = [
  {
    label: "Photo to Video Portrait",
    icon: Image,
    color: "bg-blue-50 text-blue-700",
    description:
      "Turn your photos into stunning talking video portraits with our AI-powered technology.",
  },
  {
...
export function ClientHome({
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-12 flex flex-wrap gap-4">
        {features.map((feature) => (
          <div
            ...
            onClick={() => {
              if (feature.label === "Photo to Video Portrait") {
          ...
          >
            ...
            <span className="pointer-events-none absolute -inset-5 rounded-lg border border-transparent opacity-0 shadow transition-all duration-300 group-hover:border-gray-200 group-hover:opacity-100 group-hover:shadow-md"></span>
          </div>
        ))}
      </div>
      ...
      <PhotoToVideoModal open={photoModalOpen} onChange={setPhotoModalOpen} />
